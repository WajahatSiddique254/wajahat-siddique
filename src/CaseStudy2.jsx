...
export default function CaseStudy2() {
  ...
  const challenges = [
    ...
    'Lack of executive-level insights',
  ...
  const solutions = [
    {
      ...
      desc: 'Built executive reporting solutions providing real-time visibility into organizational performance.',
      icon: <BarChart3 className="text-brand-accent w-5 h-5" />,
    },
    {
      title: 'KPI Frameworks',
      desc: 'Established standardized KPI definitions across business functions and reporting structures.',
      icon: <PieChart className="text-brand-accent w-5 h-5" />,
    },
    {
      title: 'Enterprise Reporting',
      desc: 'Delivered centralized reporting environments supporting strategic and operational decision-making.',
      icon: <Activity className="text-brand-accent w-5 h-5" />,
    },
    {
      title: 'Performance Management Analytics',
      desc: 'Enabled leadership teams to monitor business performance through interactive dashboards and analytics.',
      icon: <LineChart className="text-brand-accent w-5 h-5" />,
    },
  ];

  const engagements = [
    {
      org: 'Leading Fashion Retail Group',
      desc: 'Designed executive dashboards supporting leadership visibility across retail operations, manufacturing entities, sales performance, and organizational KPIs.',
    },
    {
      org: 'National Utility Organization',
      desc: 'Delivered enterprise analytics solutions integrating multiple SAP business functions into a centralized executive reporting platform.',
    },
    {
      org: 'National Transportation Organization',
      desc: 'Implemented analytics and reporting solutions covering numerous SAP modules and operational business areas.',
    },
    {
      org: 'Leading Manufacturing Enterprise',
      desc: 'Designed executive reporting capabilities supporting financial and operational decision-making.',
    },
  ];

  const contributions = [
    'Executive KPI Workshops', 'Analytics Strategy', 'Data Modeling',
    'Dashboard Design', 'Reporting Architecture', 'Business Requirement Analysis',
    'Stakeholder Engagement', 'User Enablement',
  ];

  const technologies = ['SAP Analytics Cloud', 'SAP BW/4HANA', 'SAP BusinessObjects', 'SAP S/4HANA'];
      ...
      <Reveal>
        <section className="py-12 sm:py-16 px-4 sm:px-6 bg-brand-dark border-t border-brand-accent/10 text-center">
          <h3 className="font-heading font-extrabold text-xl sm:text-2xl mb-4">
            Ready to unlock <span className="text-brand-accent">executive-level insights?</span>
          </h3>
          <p className="text-slate-400 text-sm mb-6 sm:mb-8 max-w-md mx-auto">
            Let's design an analytics solution that empowers your leadership team.
          </p>
